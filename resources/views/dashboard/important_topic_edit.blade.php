            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Important Topic</a></li>
                    </ol>
                </div>
                <h4 class="page-title">Edit Important Topic</h4>
            </div>
        </div>
    </div> 
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p></p><br><br>
                    <form action="{{ route('important-topic-edit', ['id' => $importantTopic->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputTopic_name" class="col-form-label">Topic Name</label>
                                <input type="text" class="form-control" id="inputTopic_name" name="topic_name" value="{{ $importantTopic->topic_name }}" placeholder="topic name">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="inputTopic_content" rows="10" name="topic_content">{{ $importantTopic->topic_content }}</textarea>
                            </div>  
                        </div>
